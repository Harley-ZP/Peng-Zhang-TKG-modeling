...
'''
ZP's reading note:
    This is the dataset class rewrite specification.
'''
class baseDataset(object):
    ...
    def getRelEntCooccurrence(self, quadruples):
        ...
        for ex in quadruples:
            ...
            # ZP: here we also add the reverse relation and object into the co-occur set.
    ...
    def get_skipdict(self, quadruples):
        ...
        # this is used for collecting all the prediction target query within each timestamp.
...
class QuadruplesDataset(Dataset):
    def __init__(self, examples, num_r):
        ...
        for ex in examples:
            ...
            # append inverse relation of each quadruples
    def __len__(self):
